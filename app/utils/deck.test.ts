...
import { calculateDeckProgress, type UserCollectionItem, type DeckCard } from "./deck";
...
describe("calculateDeckProgress", () => {
  ...
  it("should correctly sum foil and non-foil card quantities in inventory", () => {
    ...
    const userCollection: UserCollectionItem[] = [
      { user_id: "user-1", card_id: "card-A", quantity: 2, is_foil: false },
      { user_id: "user-1", card_id: "card-A", quantity: 1, is_foil: true },
    ];
  ...
  it("should cap matching card quantities at the required deck counts (no overflow from surplus)", () => {
    ...
    const userCollection: UserCollectionItem[] = [
      { user_id: "user-1", card_id: "card-A", quantity: 5, is_foil: false },
    ];
  ...
  it("should return 100% and empty missing list if user owns all cards", () => {
    ...
    const userCollection: UserCollectionItem[] = [
      { user_id: "user-1", card_id: "card-A", quantity: 2, is_foil: false },
      { user_id: "user-1", card_id: "card-B", quantity: 3, is_foil: true }, // surplus foil
    ];
