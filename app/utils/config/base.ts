...
export class BaseConfig {
  ...
  protected getEnv(key: string, envKey: string, defaultValue: string | null = null): string | null {
    if (!(this as any)[key]) {
   ...
   */
  throwIfMissing(serviceName: string, checks: Array<{ label: string; value: any }>) {
