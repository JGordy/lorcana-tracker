        ...
        <Container size="lg" py={60}>
            ...
            <SimpleGrid cols={{ base: 1, md: 3 }} spacing="lg" mt={80}>
                ...
                >
                    ...
                    <Text size="xs" c="gray.5" style={{ lineHeight: 1.5 }}>
                        ...
                        your physical Lorcana booster packs. Everything saves
                        automatically to your secure inventory.
                    </Text>
                </Card>
                ...
                >
                    ...
                    <Text size="xs" c="gray.5" style={{ lineHeight: 1.5 }}>
                        ...
                        inventory quantities against competitive deck recipes,
                        generating a completion percentage badge.
                    </Text>
                </Card>
                ...
                >
                    ...
                    <Text size="xs" c="gray.5" style={{ lineHeight: 1.5 }}>
                        ...
                        &quot;Lowest Cost to Complete&quot; to see exactly what
                        you can play or buy next with the lowest expense.
                    </Text>
                </Card>
            </SimpleGrid>
            ...
            {!user && (
                ...
                >
                    ...
                    >
                        No Appwrite cloud database credentials required to try
                        out the logic. Click the Sign In button below to launch
                        an anonymous mock-user session. We will seed a sample
                        inventory so you can see match percentages immediately!
                    </Text>
                    <Button
